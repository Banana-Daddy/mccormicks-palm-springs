// 21st.dev Component: Marquee (stroke text outlined)
// Source query: "marquee ticker scrolling"
// Date: 2026-04-29
// What we borrowed: text-stroke (WebkitTextStroke) outlined oversized type animating horizontally for the auction-results ticker — translated to vanilla CSS @keyframes animation in the HTML build.
