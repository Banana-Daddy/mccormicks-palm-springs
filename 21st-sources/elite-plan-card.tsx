// 21st.dev Component: Elite Plan Card
// Source query: "product showcase editorial"
// Date: 2026-04-29
// What we borrowed: image-on-top + dark content panel pattern with gradient fade between image and content panel — translated for vehicle lot cards. The fade-from-black bottom gradient and uppercase tracking-wider subtitle pattern map directly to a numbered auction lot ("LOT 4488 / 1934 FORD HOT ROD").
